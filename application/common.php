...
function isYesNo($str){
    return $str? '<span style="color: #ff0e1a">是</span>' :'<span>否</span>';
}
...
function status($id, $status){
 ...
 class='label label-success radius'>正常</span></a>";
    }
    elseif ($status == 0){
        $str = "<a href='javascript:;' title='待审' status_url='".$url."' onclick='app_status(this)'><span
 class='label label-danger radius'>待审</span></a>";
    }
